...
const AdminReviewsPage = () => {
  ...
  const handleReplySubmit = async (reviewId) => {
    ...
    try {
      const response = await fetch(`https://backend-opticai.onrender.com/reviews/${reviewId}/reply`, {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        const updatedResponse = await fetch('https://backend-opticai.onrender.com/reviews');

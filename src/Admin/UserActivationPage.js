...
const UserActivationPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      try {
        const response = await axios.get("https://backend-opticai.onrender.com/admin/manageActive");
  ...
  const toggleUserActivation = async (userId, currentStatus) => {
    try {
      ...
      const response = await axios.put(`https://backend-opticai.onrender.com/admin/user/${userId}/activate`, {
